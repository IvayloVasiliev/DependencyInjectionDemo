...
namespace SoftUniDI.Injectors
{
    public class Injector
    {
        ...
        {
            var hasCtorAttribute = this.CheckForCtorInjection<TClass>();
        ...
        private TClass CreateConstructorInjection<TClass>()
        {
            ...
            {
                if (!CheckForCtorInjection<TClass>())
                {
                    continue;
                }
        ...
        private TClass CreateFieldInjection<TClass>()
        {
            ...
            foreach (var fieldInfo in fields)
            {
                ...
                {
                    var injection = fieldInfo.GetCustomAttributes<InjectAttribute>(true).FirstOrDefault();
                    Type dependency = null;

                    var named = fieldInfo.GetCustomAttributes<NamedAttribute>(true);
